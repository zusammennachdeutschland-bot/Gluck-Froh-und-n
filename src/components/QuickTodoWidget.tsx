  ...
  return (
    <div className="bg-surface border border-surface-border/90 dark:border-surface-border rounded-xl shadow-2xs overflow-hidden transition-all">
      ...
      <button
        ...
        className="w-full px-2.5 py-1.5 flex items-center justify-between gap-2 text-left hover:bg-background/80 dark:hover:bg-slate-800/50 transition-colors cursor-pointer"
      ...
      {!isExpanded && activeTodosList.length > 0 && (
        <div className="px-2.5 pb-1.5 pt-0 text-[11px] text-slate-600 dark:text-slate-300 space-y-0.5 border-t border-slate-100/60 dark:border-surface-border/40">
      ...
      {isExpanded && (
        <div className="px-2.5 pb-2.5 pt-1 border-t border-slate-100 dark:border-surface-border/80 space-y-1.5">
          {/* Add Task Form */}
