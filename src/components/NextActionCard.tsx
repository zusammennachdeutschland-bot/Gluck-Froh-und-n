  ...
  return (
    <div className="space-y-2">
      ...
      <div className="flex flex-wrap items-center justify-between gap-1.5 text-xs">
        <div className="flex items-center gap-0.5 bg-surface-hover/80 p-0.5 rounded-lg">
          <button
      ...
      <div className="bg-background/70 dark:bg-surface/50 border border-surface-border/60 dark:border-surface-border/80 rounded-xl p-2.5 sm:p-3 shadow-2xs relative">
        {/* Top Header Badge */}
        <div className="flex items-center justify-between gap-2 mb-2">
          <div className="flex items-center gap-1.5 text-xs font-bold text-slate-800 dark:text-slate-200">
            <Sparkles className="w-3.5 h-3.5 text-primary dark:text-primary" />
            <span>{t('next_action_title')}</span>
            <span className="bg-surface-hover text-text-main text-[10px] px-1.5 py-0.2 rounded font-mono font-bold">
              {timeRemainingText}
            </span>
          </div>
          ...
          <div className="flex items-center gap-1">
            {nextLesson.type === 'online' ? (
              <span className="bg-primary-soft dark:bg-primary-soft/60 text-primary dark:text-primary/70 border border-primary-border dark:border-primary-border/50 text-[9px] px-1.5 py-0.2 rounded font-extrabold flex items-center gap-1">
                <Video className="w-2.5 h-2.5" />
                {t('next_action_online')}
              </span>
            ) : (
              <span className="bg-primary-soft dark:bg-primary-soft text-primary dark:text-primary border border-primary-border dark:border-primary-border text-[9px] px-1.5 py-0.2 rounded font-extrabold flex items-center gap-1">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2.5">
          <div className="flex items-start gap-2.5">
            ...
            <div>
              <h3 className="text-xs sm:text-sm font-black text-text-main leading-snug">
                {nextLesson.title}
              </h3>
              <div className="flex items-center gap-1.5 text-[10px] text-text-muted mt-0.5">
                <span className="font-bold text-text-main font-mono">{nextLesson.time}</span>
                <span>•</span>
                <span className="bg-surface-hover text-text-main font-bold px-1.5 py-0.2 rounded text-[9px]">
                  S{nextLesson.sessionNumber}/{nextLesson.totalSessionsInPackage}
                </span>
                {nextLesson.grade && (
                  <>
                    <span>•</span>
          ...
          <button
            ...
            className="w-full sm:w-auto bg-primary hover:bg-primary-hover active:scale-95 text-white font-bold text-xs px-3 py-1.5 rounded-lg transition-all flex items-center justify-center gap-1 cursor-pointer shrink-0"
          >
