...
export const CertificateCenter: React.FC = () => {
  ...
  return (
    <div className="space-y-4 pb-12">
      ...
      <div className="p-4 sm:p-5 bg-linear-to-br from-amber-500/10 via-primary/5 to-surface dark:from-amber-950/20 dark:via-primary-soft dark:to-surface rounded-3xl border border-amber-500/20 shadow-xs space-y-3.5">
        <div className="flex flex-wrap items-center justify-between gap-3">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-lg sm:text-xl font-black text-text-main flex items-center gap-2">
          ...
          <div className="flex items-center gap-2 flex-wrap">
            ...
            <button
              ...
              className="px-3 py-2 bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl font-bold text-xs flex items-center gap-1.5 transition-colors shadow-xs cursor-pointer"
            >
            ...
            <button
              ...
              className="px-3.5 py-2 bg-primary hover:bg-primary-hover text-white rounded-xl font-black text-xs flex items-center gap-1.5 transition-all shadow-xs cursor-pointer"
            >
        ...
        <div className="grid grid-cols-3 gap-2 sm:gap-3 pt-1 text-center">
          <div className="p-2.5 bg-surface/80 dark:bg-slate-900/80 rounded-2xl border border-surface-border dark:border-slate-800">
            ...
            <span className="block text-base sm:text-xl font-black text-amber-600 dark:text-amber-400">
              {activeCertificates.length}
            </span>
          </div>
          ...
          <div className="p-2.5 bg-surface/80 dark:bg-slate-900/80 rounded-2xl border border-surface-border dark:border-slate-800">
            ...
            <span className="block text-base sm:text-xl font-black text-primary">
      ...
      {/* Sub Tabs Bar */}
      <div className="flex items-center justify-between gap-1 p-1 bg-slate-100 dark:bg-slate-800/60 rounded-2xl border border-surface-border dark:border-slate-800">
        <button
          onClick={() => setActiveSubTab('to_honor')}
          className={`flex-1 py-2 px-2.5 rounded-xl font-black text-xs transition-all cursor-pointer text-center ${
            activeSubTab === 'to_honor'
              ? 'bg-surface dark:bg-slate-900 text-primary shadow-xs'
      ...
      <div className="flex flex-wrap items-center gap-2">
        <div className="relative flex-1 min-w-[180px]">
          ...
          <input
            ...
            className="w-full pl-9 pr-3 py-2 bg-surface dark:bg-slate-900 border border-surface-border dark:border-slate-800 rounded-xl text-xs font-bold text-text-main focus:outline-none focus:ring-2 focus:ring-primary"
          />
        </div>
        ...
        <select
          ...
          className="bg-surface dark:bg-slate-900 border border-surface-border dark:border-slate-800 rounded-xl px-3 py-2 text-xs font-bold text-text-main focus:outline-none focus:ring-2 focus:ring-primary"
        >
      ...
      {activeSubTab === 'to_honor' && (
        <div>
          {studentsToHonor.length === 0 ? (
            <div className="p-8 text-center bg-surface dark:bg-slate-900 rounded-3xl border border-surface-border dark:border-slate-800 space-y-2">
              <Award className="w-10 h-10 text-text-muted/40 mx-auto" />
              <h3 className="font-black text-sm text-text-main">{_t('لا يوجد طلاب مطابقين للبحث', 'No students found', 'Keine Schüler gefunden')}</h3>
              <p className="text-xs text-text-muted">{_t('قم بتغيير خيارات التصفية أو البحث', 'Try adjusting your search filters', 'Passen Sie Ihre Suchfilter an')}</p>
            </div>
          ) : (
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-3">
              ...
              return (
                <div
                  key={student.id}
                  className="p-3.5 sm:p-4 bg-surface dark:bg-slate-900 border border-surface-border dark:border-slate-800 rounded-2xl flex items-center justify-between gap-3 hover:border-slate-300 dark:hover:border-slate-700 transition-all shadow-2xs"
                >
                  ...
                  <div className="flex items-center gap-2 shrink-0">
                    <button
                      ...
                      className="px-3.5 py-2 bg-amber-500 hover:bg-amber-600 text-white rounded-xl font-black text-xs flex items-center gap-1.5 transition-all shadow-xs cursor-pointer"
                    >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {honoredStudentsList.length === 0 ? (
            <div className="p-8 text-center bg-surface dark:bg-slate-900 rounded-3xl border border-surface-border dark:border-slate-800 space-y-2">
              ...
              <h3 className="font-black text-sm text-text-main">{_t('لم يتم إصدار شهادات بعد', 'No honored students yet', 'Noch keine geehrten Schüler')}</h3>
              <p className="text-xs text-text-muted">{_t('ابدأ بإصدار شهادات لطلابك المتميزين', 'Start issuing certificates to your outstanding students', 'Stellen Sie Zertifikate für Ihre Schüler aus')}</p>
            </div>
          ) : (
            honoredStudentsList.map(student => {
              ...
              return (
                <div
                  key={student.id}
                  className="p-4 bg-surface dark:bg-slate-900 border border-surface-border dark:border-slate-800 rounded-2xl space-y-3 shadow-2xs"
                >
                  <div className="flex items-center justify-between gap-3">
                    <div className="flex items-center gap-3 min-w-0">
                      ...
                      <div className="min-w-0">
                        <h4 className="font-black text-sm text-text-main truncate">
                          {student.name}
                        </h4>
                    ...
                    <button
                      onClick={() => handleOpenCreateForStudent(student.id)}
                      className="px-3 py-1.5 bg-surface dark:bg-slate-800 border border-surface-border dark:border-slate-700 hover:bg-slate-100 dark:hover:bg-slate-700 text-text-main rounded-xl font-bold text-xs flex items-center gap-1 transition-colors cursor-pointer"
                    >
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 pt-1 border-t border-surface-border dark:border-slate-800">
                    {studentCerts.map(cert => (
                      <div
                        key={cert.id}
                        onClick={() => setSelectedCertForPreview(cert)}
                        className="p-2.5 bg-slate-50 dark:bg-slate-800/40 border border-surface-border dark:border-slate-800 rounded-xl flex items-center justify-between gap-2 hover:border-primary/40 transition-colors cursor-pointer"
                      >
                        <div className="min-w-0">
                          <span className="block font-black text-xs text-text-main truncate">{cert.courseOrLevelTitle}</span>
                          <span className="block text-[10px] text-text-muted truncate">{cert.issueDate} • {cert.type}</span>
                        </div>
                        <div className="flex items-center gap-1 shrink-0">
                          ...
                          <button
                            ...
                            className="p-1.5 text-text-muted hover:text-emerald-500 transition-colors cursor-pointer"
                            title="Share"
                          >
      ...
      {activeSubTab === 'archive' && (
        <div className="space-y-3">
          {filteredArchive.length === 0 ? (
            <div className="p-8 text-center bg-surface dark:bg-slate-900 rounded-3xl border border-surface-border dark:border-slate-800 space-y-2">
              <Award className="w-10 h-10 text-text-muted/40 mx-auto" />
              <h3 className="font-black text-sm text-text-main">{_t('لا توجد شهادات في الأرشيف', 'No certificates found', 'Keine Zertifikate gefunden')}</h3>
              <p className="text-xs text-text-muted">{_t('قم بإصدار شهادات جديدة لتظهر هنا في الأرشيف', 'Issued certificates will be archived here', 'Ausgestellte Zertifikate werden hier archiviert')}</p>
            </div>
          ) : (
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-3.5">
              {filteredArchive.map(cert => {
                ...
                return (
                  <div
                    key={cert.id}
                    className="p-4 bg-surface dark:bg-slate-900 border border-surface-border dark:border-slate-800 rounded-2xl flex flex-col justify-between gap-3 hover:border-slate-300 dark:hover:border-slate-700 transition-all shadow-2xs"
                  >
                    <div className="space-y-2">
                      ...
                      <div>
                        ...
                        <span className="block text-xs font-bold text-primary truncate mt-0.5">
                    ...
                    <div className="flex items-center justify-between pt-2 border-t border-surface-border dark:border-slate-800 text-xs">
                      ...
                      <div className="flex items-center gap-1.5">
                        <button
                          onClick={() => setSelectedCertForPreview(cert)}
                          className="p-2 bg-slate-50 dark:bg-slate-800 text-text-main hover:bg-slate-100 dark:hover:bg-slate-700 rounded-xl transition-colors cursor-pointer"
                          title="View"
                        >
                        ...
                        <button
                          ...
                          className="p-2 bg-primary/10 text-primary hover:bg-primary hover:text-white rounded-xl transition-colors cursor-pointer"
                          title="Download PDF"
                        >
                          <Download className="w-3.5 h-3.5" />
                        </button>
                        <button
                          ...
                          className="p-2 bg-emerald-500/10 text-emerald-600 hover:bg-emerald-600 hover:text-white rounded-xl transition-colors cursor-pointer"
                          title="WhatsApp"
                        >
                          <Share2 className="w-3.5 h-3.5" />
                        </button>
