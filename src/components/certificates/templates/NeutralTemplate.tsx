    ...
    >
      ...
      <div className="text-center relative z-10 pt-2 sm:pt-4">
        <div className="inline-flex items-center justify-center gap-3 mb-2">
          <div className="w-10 sm:w-16 h-[2px] bg-gradient-to-r from-transparent via-[#d4af37] to-[#d4af37]" />
          ...
          <div className="w-10 sm:w-16 h-[2px] bg-gradient-to-l from-transparent via-[#d4af37] to-[#d4af37]" />
        </div>
        ...
        {certificate.subtitle && (
          <p className="text-xs sm:text-sm text-[#78350f] font-semibold mt-1 max-w-xl mx-auto italic font-sans">
            {certificate.subtitle}
          </p>
        )}
      </div>
      ...
      <div className="text-center my-auto py-2 sm:py-4 relative z-10 w-full max-w-3xl mx-auto">
        ...
        {/* Student Recipient Name - Huge Hero Element with Auto-Fit */}
