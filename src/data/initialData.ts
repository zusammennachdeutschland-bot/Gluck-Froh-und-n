...
export const INITIAL_TODOS: any[] = [];
export const INITIAL_CERTIFICATES: any[] = [];
export const INITIAL_SCHOOL_NOTES: any[] = [];
export const INITIAL_HOD_STUDENTS: any[] = [];
export const INITIAL_HOD_VISITS: any[] = [];
export const INITIAL_HOD_ACTION_PLANS: any[] = [];
export const INITIAL_HOD_COMPLAINTS: any[] = [];
export const INITIAL_FINANCE_ACCOUNTS: any[] = [];
export const INITIAL_FINANCE_TRANSACTIONS: any[] = [];
